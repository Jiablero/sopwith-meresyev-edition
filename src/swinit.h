...
extern void initcomp(OBJECTS *obp, const original_ob_t *orig_ob);
extern void initplyr(OBJECTS *obp, const original_ob_t *orig_ob);
extern OBJECTS *initpln(OBJECTS *obp, const original_ob_t *orig_ob);
